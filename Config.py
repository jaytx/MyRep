        ...
        with self.graph.as_default():
            with self.sess.as_default():
                ...
                if self.test_triple_classification:
                    ...
                    test_tail_triples=self.test_pos_r

                    res_neg = self.test_step(self.test_neg_h, self.test_neg_t, self.test_neg_r)
                    print("pre class")
                    self.lib.test_triple_classification(self.relThresh_addr,test_tail_triples.__array_interface__['data'][0], res_pos.__array_interface__['data'][0], res_neg.__array_interface__['data'][0], self.acc_addr)
